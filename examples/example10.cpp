 ...
 *	Copyright 2025 Andreas Rönnquist
 *
...
int main(int argc, char **argv)
{
   ...
   try {
      ...
      GraphicsHandler::instance().setGraphicsMode(Vector2d(640, 480), false, true);

      Vector2d displayResoltion = GraphicsHandler::instance().getDisplayResolution();
      ...
      // set a window title
      GraphicsHandler::instance().setWindowTitle("GusGame Example 8");
      ...
      LOG("Load font");
      font = new BitmapFont("a4_font.tga");
   ...
   do {
      ...
      Primitives::rectFill(GraphicsHandler::instance().getScreenRect(), Color(0.0f, 0.0f, 1.0f));
      ...
      font->draw(Vector2d(90, 90), "REAL TEST", Color(1.0f, 1.0f, 1.0f));
